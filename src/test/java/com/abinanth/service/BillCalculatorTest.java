...
public class BillCalculatorTest {
	...
	public void correctRecidencyTypeAndCity() {
		...
		BillCalculatorModel recidencyDetails = new BillCalculatorModel("7140", "textile", "13/31", "deepam nagar",
				"irugur", "cbe", "2");
	...
	public void inCorrectRecidencyTypeAndCity() {
		...
		BillCalculatorModel recidencyDetails = new BillCalculatorModel("7141", "", "13/3a", "deepam nagar", "Irugur",
				"CBE", "2");
		boolean isValid = BillCalculatorService.addRecidencyDetails(recidencyDetails);
